...
#define DELTA_SMOOTH_ROD_OFFSET 166.0 // mm
...
//                          (but g ives greater accuracy and more stable PID)
...
#define MAX_HEATING_CHECK_MILLIS (120UL * 1000UL)
...
#define STEPS_PER_UNIT_DELTA 78.7402

#define DEFAULT_AXIS_STEPS_PER_UNIT   {STEPS_PER_UNIT_DELTA, STEPS_PER_UNIT_DELTA, STEPS_PER_UNIT_DELTA, 73}  // default steps per unit for ultimaker2
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 80}    // (mm/sec)
